...
def _config(agent: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "bin_dir": config.get("bin_dir") or "",
        "runtime_dir": config.get("runtime_dir") or "",
        "asset_name": config.get("asset_name") or "",
        "download_url": config.get("download_url") or "",
        "binary_sha256": config.get("binary_sha256") or "",
